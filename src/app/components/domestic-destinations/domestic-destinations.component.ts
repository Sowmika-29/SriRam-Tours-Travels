...
export class DomesticDestinationsComponent implements OnInit {
  ...
  destinations = [
    { name: 'Munnar', tagline: 'Wake up to misty tea estates.', image: 'https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?w=800&q=80' },
    ...
    { name: 'Sikkim', tagline: 'Hidden Himalayan treasure, untouched.', image: 'https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?w=800&q=80' },
    { name: 'Ladakh', tagline: 'The roof of the world awaits you.', image: 'https://images.unsplash.com/photo-1597074866923-dc0589150358?w=800&q=80' }
  ];
